...
GDXy2<-function(X,y,b=NULL,learningRate=1/50,nIter=100,centerX=TRUE,scaleX=FALSE,
               pctChangeRSS=0.02,earlyStop=FALSE,returnPath=FALSE,verbose=FALSE){
