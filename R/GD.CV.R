...
GD.CV=function(X,y,nTst=round(nrow(X)*0.2),nRep=10,nIter=100,seed=NULL,b=rep(0,ncol(X)),...){
	...
	COR=data.frame(nIter=1:nIter,Cor=colMeans(COR),SD=apply(FUN=sd,X=COR,MARGIN=2))
